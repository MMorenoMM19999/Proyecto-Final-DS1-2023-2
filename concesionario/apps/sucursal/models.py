...
class Sucursal(models.Model):
    ...
    vehiculos = models.ManyToManyField(Vehiculo,through='SucursalVehiculo',related_name='sucursal',default='')
    #Repuestos que tiene la sucursal
    #related_name para poder acceder desde una instancia repuesto a su sucursal
    repuestos = models.ManyToManyField(Repuesto,through='SucursalRepuesto',related_name='sucursal',default='')
    ...
    #Permite determinar una represetacion en string para el objeto 
...
class SucursalVehiculo(models.Model):
    ...
    sucursal = models.ForeignKey(Sucursal,default=None,  on_delete=models.CASCADE,)
    #Vehiculo
...
class SucursalRepuesto(models.Model):
    ...
    sucursal = models.ForeignKey(Sucursal,default=None,  on_delete=models.CASCADE)
    #Repuesto
    repuesto = models.ForeignKey(Repuesto,default=None,  on_delete=models.CASCADE)
    #Cantidad disponible en stock del repuesto en la sucursal
    cantidad = models.IntegerField(null=True,blank=True)
